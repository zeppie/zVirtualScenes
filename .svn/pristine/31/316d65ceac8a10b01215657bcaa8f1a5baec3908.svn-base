    ...
    public partial class uc_device_commands : UserControl
    {
        ...
        public void UpdateObject(long device_id)
        {
            ...
            using (zvsEntities2 db = new zvsEntities2(zvsEntityControl.GetzvsConnectionString))
            {
                ...
                CommandLabel.Text = "'" + device.friendly_name + "' specific commands:" + (device.device_commands.Count > 0 ? "" : " None.");
                ...
                foreach (device_commands d_cmd in device.device_commands)
                {
        ...
        private void btnClick(object sender, EventArgs e)
        {
            ...
            device_command_que cmd = device_command_que.Createdevice_command_que(0, device_id, dc.id, arg);
